    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          className={`flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${newSkill ? "text-black" : "text-gray-400"}`}
        />
